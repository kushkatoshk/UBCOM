...
public class Barchar1 extends ApplicationFrame {
public String category = "";
public String mainTitle = "";
public Barchar1(final String title  ,int firstVal,int secondVal,int thirdVal) {
        super(title);
        mainTitle = title;
...
public Barchar1(final String title  ,ArrayList<Float> freqs,ArrayList<String> brands) {
        super(title);
        mainTitle = title;
        final CategoryDataset dataset = createDataset(title,freqs,brands);
        final JFreeChart chart = createChart(dataset);
        final ChartPanel chartPanel = new ChartPanel(chart);
        chartPanel.setPreferredSize(new Dimension(500, 270));
        setContentPane(chartPanel);
...
public Barchar1(final String title , ArrayList<String> allUsers , ArrayList<Integer> allNonSwamCounts,ArrayList<Integer> allSwamCounts) {
        super(title);
        mainTitle = title;
...
//
  ...
  public Barchar1(final String title  ,String message1,String message2,int posCount,int negCount) {
        super(title);
        mainTitle = title;
  ...
  private CategoryDataset createDataset(String title,ArrayList<Float> fr , ArrayList<String> br){
       final DefaultCategoryDataset dataset = new DefaultCategoryDataset();
       for(int i=0;i<fr.size();i++){
       dataset.addValue(fr.get(i), br.get(i)+"", br.get(i));
       }
