 ...
 */
@WebService(serviceName = "samsung")
...
//            }
            data = new String(bb);
            data +="\r\n"+ txt;
           FileOutputStream fos = new FileOutputStream("C:\\myfinal project\\datacenter\\samsung.txt"); 
        ...
        return "tweet updated to samsung service...!";
    }
}
